  ...
  return (
    <div className="relative text-white font-sans overflow-x-hidden antialiased selection:bg-brand-500 selection:text-white">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none bg-[#181411]">
        ...
        <div className="absolute top-0 left-1/4 w-[700px] h-[700px] bg-brand-500/15 rounded-full blur-[130px] animate-blob"></div>
      ...
      <div className="relative z-10">
        ...
        <section className="py-32 px-6 relative overflow-hidden">
          <div className="absolute inset-0 bg-linear-to-t from-brand-500/10 to-transparent pointer-events-none"></div>
          <div className="max-w-4xl mx-auto text-center relative z-10">
            <h2 className="text-4xl md:text-5xl font-black mb-6">Ready to Simplify Your AI Infrastructure?</h2>
            <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
              Join developers who are streamlining their AI integrations with Orbit Router. Open source and free to start.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button 
                onClick={() => router.push("/dashboard")}
                className="w-full sm:w-auto h-14 px-10 rounded-lg bg-brand-500 hover:bg-brand-600 text-white text-lg font-bold transition-all shadow-[var(--shadow-warm)]"
              >
                Start Free
              </button>
              <button 
